...
const Print = ({ currentUser }) => {
  ...
  return (
    <div className="grid px-20  ">
      <button
        onClick={handlePrint}
        className=" cursor-pointer py-1 px-2  rounded-md font-bold mb-2 "
      >
        Print
      </button>
      <div ref={printRef} className="flex WMmessage">
        {/* right */}
        ...
        <div className=" p-5  ">
          <div className="grid">
            ...
            <span>
              <span className="font-bold">Date/Time In:</span> 03/29/2024 12:33
              AM
            </span>
          </div>
